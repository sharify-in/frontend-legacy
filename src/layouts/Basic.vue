<template>
  <a-config-provider :theme="style">
    <div
      class="flex flex-row items-center justify-center gap-2 flex-wrap mb-10"
    >
      <a
        href="/"
        draggable="false"
        class="select-none flex flex-row items-center mr-20"
      >
        <img :src="Logo" draggable="false" class="w-16" />
        <h1 class="font-black uppercase">Sharify</h1>
      </a>

      <div class="flex gap-5 flex-wrap">
        <a href="/" class="text-center hover:underline">Features</a>
        <a href="/dashboard/premium" class="text-center hover:underline"
          >Premium</a
        >
        <a href="https://dsc.gg/sharify" class="text-center hover:underline"
          >Community</a
        >
      </div>
    </div>
