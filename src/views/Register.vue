    ...
    <XyzTransition appear xyz="fade down duration-10 delay-1.5">
      <Card v-if="true" class="flex flex-col items-center w-full md:w-96">
        ...
        <template #content>
          ...
          <form v-if="request.done && !request.error" @submit.prevent="register()">
            <div class="flex flex-col gap-6">
              <div class="p-inputgroup flex-1">
                ...
                <span class="p-float-label">
                  <InputText id="username" class="p-inputtext-lg" v-model="formValues.username" />
              ...
              <div class="flex align-items-center">
                <Checkbox v-model="formValues.agree" :binary="true" inputId="agree" name="agree" />
                <label for="agree" class="ml-2"> I agree to the Terms of Service </label>
              </div>
              <Button type="submit" iconPos="right" :loading="registerRequest.loading">
